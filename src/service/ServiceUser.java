...
public class ServiceUser {
    ...
    //  SQL
    private final String LOGIN = "select UserID, user_account.UserName, Gender, ImageString from `user1` join user_account using (UserID) where `user1`.UserName=BINARY(?) and `user1`.`Password`=BINARY(?) and user_account.`Status`='1'";
